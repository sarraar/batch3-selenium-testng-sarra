...
public class StaleElement  extends TestBase {
    // TestBase deki before classtaki  driver.get(ConfigurationReader.... comment out yapmadan calismaz!?
    ...
    public void staleProblem() {
        ...
        WebElement emailInput=driver.findElement(By.xpath("//input[@placeholder='E-mail address']"));
